...
public class BtHelper {
    private static final String TAG = "BtAutomation.BtHelper";
    ...
    public boolean IsConnectedToDevice(String deviceName)
    {
        if (mBluetoothAdapter.getState() == BluetoothAdapter.STATE_ON) {
            if (mBluetoothAdapter.getProfileConnectionState(BT_PAN_PROFILE) ==
